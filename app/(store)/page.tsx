    ...
    <main className="flex-col items-center justify-between min-h-screen bg-white">
      <section className="relative w-full min-h-[82vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden bg-brand-brown">
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-2.5 sm:mt-4 text-xs sm:text-base text-white/90 max-w-lg mx-auto leading-relaxed drop-shadow">
            {heroSubheadline}
          </p>
      ...
      <section className="pb-7 sm:pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#A8826B] via-[#8A7750] to-[#3D2B21] text-white border border-[#A8826B]/30 shadow-[0_16px_45px_rgba(171,148,98,0.2)] flex flex-col md:flex-row md:items-stretch md:max-h-[280px]">
