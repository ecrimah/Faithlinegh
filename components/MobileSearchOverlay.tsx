...
export default function MobileSearchOverlay({ isOpen, onClose }: MobileSearchOverlayProps) {
  ...
  const searchSuggestions = [
    { name: 'Summer Floral Dress', category: 'Women\'s Clothing', price: '₵289', image: '/placeholder-product.svg' },
    { name: 'Classic Leather Handbag', category: 'Bags', price: '₵459', image: '/placeholder-product.svg' },
    { name: 'Designer Sunglasses', category: 'Accessories', price: '₵199', image: '/placeholder-product.svg' }
  ];
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-brand-cream rounded-full text-sm text-brand-brown focus:outline-none focus:ring-2 focus:ring-brand-brown/30"
              autoFocus
            />
